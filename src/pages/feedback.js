                          ...
                          >
                            ...
                            <Field
                              ...
                              validate={(value) => {
                                let error;
                                if (value.length < 2)
                                  error = "There may be an error in the name";
                          ...
                          >
                            ...
                            <Field
                              ...
                              validate={(value) => {
                                let error;
                                if (
                                  !/^\+998([- ])?(90|91|93|94|95|98|99|33|97|71)([- ])?(\d{3})([- ])?(\d{2})([- ])?(\d{2})$/i.test(
                                    value
                                  )
                                )
                                  error =
                                    "There may be an error in the phone number";
                          ...
                          >
                            ...
                            <Field
                              ...
                              validate={(value) => {
                                ...
                                if (!value)
                                  error =
                                    "There may be an error in the message";
